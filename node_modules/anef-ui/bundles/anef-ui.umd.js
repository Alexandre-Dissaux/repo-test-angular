(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('primeng/breadcrumb'), require('primeng/menubar'), require('primeng/dialog'), require('primeng/message'), require('rxjs'), require('rxjs/operators'), require('primeng/dropdown'), require('lodash'), require('primeng/radiobutton'), require('primeng/inputtextarea'), require('primeng/panelmenu'), require('primeng/inputswitch'), require('primeng/progressspinner'), require('primeng/selectbutton'), require('primeng/checkbox'), require('primeng/multiselect'), require('@fullcalendar/daygrid'), require('@fullcalendar/timegrid'), require('@fullcalendar/interaction'), require('@fullcalendar/list'), require('moment'), require('@fullcalendar/core/locales-all'), require('primeng/fullcalendar'), require('primeng/calendar'), require('primeng/tabview'), require('@angular/common'), require('@angular/forms'), require('@angular/platform-browser'), require('primeng/inputtext'), require('primeng/button'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('anef-ui', ['exports', 'primeng/breadcrumb', 'primeng/menubar', 'primeng/dialog', 'primeng/message', 'rxjs', 'rxjs/operators', 'primeng/dropdown', 'lodash', 'primeng/radiobutton', 'primeng/inputtextarea', 'primeng/panelmenu', 'primeng/inputswitch', 'primeng/progressspinner', 'primeng/selectbutton', 'primeng/checkbox', 'primeng/multiselect', '@fullcalendar/daygrid', '@fullcalendar/timegrid', '@fullcalendar/interaction', '@fullcalendar/list', 'moment', '@fullcalendar/core/locales-all', 'primeng/fullcalendar', 'primeng/calendar', 'primeng/tabview', '@angular/common', '@angular/forms', '@angular/platform-browser', 'primeng/inputtext', 'primeng/button', '@angular/core'], factory) :
    (factory((global['anef-ui'] = {}),global.breadcrumb,global.menubar,global.dialog,global.message,global.rxjs,global.rxjs.operators,global.dropdown,global.lodash,global.radiobutton,global.inputtextarea,global.panelmenu,global.inputswitch,global.progressspinner,global.selectbutton,global.checkbox,global.multiselect,global.dayGridPlugin,global.timeGridPlugin,global.interactionPlugin,global.listPlugin,global.moment,global.allLocales,global.fullcalendar,global.calendar,global.tabview,global.ng.common,global.ng.forms,global.ng.platformBrowser,global.inputtext,global.button,global.ng.core));
}(this, (function (exports,breadcrumb,menubar,dialog,message,rxjs,operators,dropdown,lodash,radiobutton,inputtextarea,panelmenu,inputswitch,progressspinner,selectbutton,checkbox,multiselect,dayGridPlugin,timeGridPlugin,interactionPlugin,listPlugin,moment,allLocales,fullcalendar,calendar,tabview,common,forms,platformBrowser,inputtext,button,core) { 'use strict';
    ...
    listPlugin = listPlugin && listPlugin.hasOwnProperty('default') ? listPlugin['default'] : listPlugin;
    moment = moment && moment.hasOwnProperty('default') ? moment['default'] : moment;
    allLocales = allLocales && allLocales.hasOwnProperty('default') ? allLocales['default'] : allLocales;
    ...
    var BreadcrumbModule = /** @class */ (function () {
        ...
        BreadcrumbModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [breadcrumb.BreadcrumbModule],
    ...
    var TileComponent = /** @class */ (function () {
        ...
        TileComponent.propDecorators = {
            ...
            tileClass: [{ type: core.HostBinding, args: ['class.ui-tile',] }]
        };
    ...
    var NavigationBarModule = /** @class */ (function () {
        ...
        NavigationBarModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, menubar.MenubarModule],
    ...
    var ErrorModalComponent = /** @class */ (function () {
        function ErrorModalComponent() {
            this.displayErrorChange = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        ErrorModalComponent.propDecorators = {
            displayError: [{ type: core.Input }],
            title: [{ type: core.Input }],
            titleCheck: [{ type: core.Input }],
            text: [{ type: core.Input }],
            facultativeText: [{ type: core.Input }],
            labelBtn: [{ type: core.Input }],
            textBold: [{ type: core.Input }],
            displayErrorChange: [{ type: core.Output }]
        };
    ...
    var SuccessModalComponent = /** @class */ (function () {
        function SuccessModalComponent() {
            this.displaySuccessChange = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        SuccessModalComponent.propDecorators = {
            displaySuccess: [{ type: core.Input }],
            title: [{ type: core.Input }],
            titleCheck: [{ type: core.Input }],
            text: [{ type: core.Input }],
            facultativeText: [{ type: core.Input }],
            labelBtn: [{ type: core.Input }],
            textBold: [{ type: core.Input }],
            displaySuccessChange: [{ type: core.Output }]
        };
    ...
    var ConfirmModalComponent = /** @class */ (function () {
        ...
        ConfirmModalComponent.propDecorators = {
            ...
            title: [{ type: core.Input }],
            classIcon: [{ type: core.Input }],
            titleIcon: [{ type: core.Input }],
            textBold: [{ type: core.Input }],
            text: [{ type: core.Input }],
            warning: [{ type: core.Input }],
            closeBtn: [{ type: core.Input }],
            confirmBtn: [{ type: core.Input }],
            confirmBtnClass: [{ type: core.Input }],
            closeBtnClass: [{ type: core.Input }],
    ...
    var InformationModalComponent = /** @class */ (function () {
        function InformationModalComponent() {
            ...
            this.displayInfoChange = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        InformationModalComponent.propDecorators = {
            ...
            labelBtn: [{ type: core.Input }],
            textBold: [{ type: core.Input }],
            hideIconBloc: [{ type: core.Input }],
            displayInfoChange: [{ type: core.Output }]
        };
    ...
    var GenericModalComponent = /** @class */ (function () {
        function GenericModalComponent() {
            this.modalWidth = 60;
            this.displayGenericModalChange = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        GenericModalComponent.propDecorators = {
            displayGenericModal: [{ type: core.Input }],
            title: [{ type: core.Input }],
            hideCloseBtn: [{ type: core.Input }],
            hideConfirmBtn: [{ type: core.Input }],
            closeBtn: [{ type: core.Input }],
            confirmBtn: [{ type: core.Input }],
            modalClass: [{ type: core.Input }],
            confirmBtnClass: [{ type: core.Input }],
            closeBtnClass: [{ type: core.Input }],
            disableConfirmBtn: [{ type: core.Input }],
            modalWidth: [{ type: core.Input }],
            displayGenericModalChange: [{ type: core.Output }]
        };
    ...
    var ModalRadioComponent = /** @class */ (function () {
        function ModalRadioComponent() {
            ...
            this.selectionClosed = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        ModalRadioComponent.propDecorators = {
            displayModalRadio: [{ type: core.Input }],
            title: [{ type: core.Input }],
            topContentText: [{ type: core.Input }],
            warningMessage: [{ type: core.Input }],
            hideCloseBtn: [{ type: core.Input }],
            hideConfirmBtn: [{ type: core.Input }],
            closeBtn: [{ type: core.Input }],
            confirmBtn: [{ type: core.Input }],
            ...
            confirmBtnClass: [{ type: core.Input }],
            closeBtnClass: [{ type: core.Input }],
            preSelectedIndex: [{ type: core.Input }],
            radioList: [{ type: core.Input }],
            radioLabels: [{ type: core.Input }],
            selectionChanged: [{ type: core.Output }],
            selectionClosed: [{ type: core.Output }]
        };
    ...
    var InputDateComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this.dateChanges = rxjs.merge(dayChanges, monthChanges, yearChanges);
         ...
         */
            function () {
                var _this = this;
                this.dateChanges.pipe(operators.debounceTime(200), operators.takeUntil(this.notifier)).subscribe(( /**
                 * @return {?}
                 */function () {
                    _this.resetErrors();
                    /** @type {?} */
        ...
        InputDateComponent.propDecorators = {
            ...
            defaultDisplay: [{ type: core.Input }],
            dayName: [{ type: core.Input }],
            dayLabel: [{ type: core.Input }],
            dayPlaceholder: [{ type: core.Input }],
            monthName: [{ type: core.Input }],
            monthLabel: [{ type: core.Input }],
            monthPlaceholder: [{ type: core.Input }],
            yearName: [{ type: core.Input }],
            yearRequired: [{ type: core.Input }],
            yearLabel: [{ type: core.Input }],
            yearPlaceholder: [{ type: core.Input }],
            model: [{ type: core.Input }],
            monthOptions: [{ type: core.Input }],
    ...
    var InputDateModule = /** @class */ (function () {
        ...
        InputDateModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.FormsModule, forms.ReactiveFormsModule, inputtext.InputTextModule, dropdown.DropdownModule],
    ...
    var InputDateApproxComponent = /** @class */ (function () {
         ...
         */
            function () {
                /** @type {?} */
                var validatorsArray = [];
                validatorsArray.push(forms.Validators.min(1), forms.Validators.max(31));
         ...
         */
            function () {
                ...
                this.formGroup.get(this.dateApproxCheckboxName).valueChanges
                    .pipe(operators.startWith(this.formGroup.get(this.dateApproxCheckboxName).value), operators.distinctUntilChanged(), operators.takeUntil(this.notifier))
                    .subscribe(( /**
             * @param {?} value
             * @return {?}
             */function (value) {
         ...
         */
            function () {
                ...
                this.formGroup.get(this.monthName).valueChanges
                    .pipe(operators.startWith(this.formGroup.get(this.monthName).value), operators.distinctUntilChanged(), operators.takeUntil(this.notifier))
                    .subscribe(( /**
             * @return {?}
             */function () {
        ...
        InputDateApproxComponent.propDecorators = {
            ...
            monthOptions: [{ type: core.Input }],
            messages: [{ type: core.Input }],
            canBeApproximative: [{ type: core.Input }],
            dateApproxLabel: [{ type: core.Input }],
            dateApproxCheckboxName: [{ type: core.Input }],
            dateApproxMasks: [{ type: core.Input }],
            dateApproxMaskName: [{ type: core.Input }],
            maxDate: [{ type: core.Input }],
            maxDateErrorMessage: [{ type: core.Input }],
            minDate: [{ type: core.Input }],
            minDateErrorMessage: [{ type: core.Input }]
        };
    ...
    var InputTextComponent = /** @class */ (function () {
        ...
        InputTextComponent.propDecorators = {
            ...
            messages: [{ type: core.Input }],
            textAfterReadOnly: [{ type: core.Input }]
        };
    ...
    var InputTextModule = /** @class */ (function () {
        ...
        InputTextModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.ReactiveFormsModule, inputtext.InputTextModule],
    ...
    var InputSelectModule = /** @class */ (function () {
        ...
        InputSelectModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.ReactiveFormsModule, dropdown.DropdownModule],
    ...
    var InputRadioModule = /** @class */ (function () {
        ...
        InputRadioModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.ReactiveFormsModule, radiobutton.RadioButtonModule],
    ...
    var InputCheckModule = /** @class */ (function () {
        ...
        InputCheckModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.ReactiveFormsModule, checkbox.CheckboxModule],
    ...
    var InputTextareaModule = /** @class */ (function () {
        ...
        InputTextareaModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.ReactiveFormsModule, inputtextarea.InputTextareaModule],
    ...
    var InputDateTwoWayBindingComponent = /** @class */ (function () {
        function InputDateTwoWayBindingComponent() {
            ...
            this.checkboxValueChanged = new core.EventEmitter();
        ...
        InputDateTwoWayBindingComponent.propDecorators = {
            ...
            disableDateOnCheck: [{ type: core.Input }],
            errors: [{ type: core.Input }],
            ngModelChange: [{ type: core.Output }],
            checkboxValueChanged: [{ type: core.Output }]
        };
    ...
    var InputDateTwoWayBindingModule = /** @class */ (function () {
        ...
        InputDateTwoWayBindingModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.FormsModule, calendar.CalendarModule, checkbox.CheckboxModule],
    ...
    var InputSelectTwoWayBindingComponent = /** @class */ (function () {
         ...
         */
            function () {
                 ...
                 * @param {?} option
                 * @return {?}
                 */function (option) { return lodash.isEqual(_this.model, option.value); }));
        ...
        InputSelectTwoWayBindingComponent.propDecorators = {
            model: [{ type: core.Input }],
            required: [{ type: core.Input }],
            showDeleteItemsButton: [{ type: core.Input }],
            readonly: [{ type: core.Input }],
            disabled: [{ type: core.Input }],
            label: [{ type: core.Input }],
            placeholder: [{ type: core.Input }],
    ...
    var InputSelectTwoWayBindingModule = /** @class */ (function () {
        ...
        InputSelectTwoWayBindingModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.FormsModule, dropdown.DropdownModule, button.ButtonModule],
    ...
    var InputMultiSelectTwoWayBindingComponent = /** @class */ (function () {
         ...
         */
            function (value) {
                 ...
                 * @param {?} option
                 * @return {?}
                 */function (option) { return lodash.isEqual(value, option.value); }));
    ...
    var InputRadioTwoWayBindingModule = /** @class */ (function () {
        ...
        InputRadioTwoWayBindingModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.FormsModule, radiobutton.RadioButtonModule],
    ...
    var InputTextareaTwoWayBindingModule = /** @class */ (function () {
        ...
        InputTextareaTwoWayBindingModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.FormsModule, inputtextarea.InputTextareaModule],
    ...
    ***************************************************************************** */
    ...
    var VerticalMenuComponent = /** @class */ (function () {
        ...
        VerticalMenuComponent.propDecorators = {
            ...
            isWithMarkers: [{ type: core.Input }],
            handleScroll: [{ type: core.HostListener, args: ['window:scroll',] }]
        };
    ...
    var VerticalMenuModule = /** @class */ (function () {
        ...
        VerticalMenuModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, panelmenu.PanelMenuModule],
    ...
    var InputSwitchComponent = /** @class */ (function () {
        ...
        InputSwitchComponent.propDecorators = {
            formGroup: [{ type: core.Input }],
            controlName: [{ type: core.Input }],
            choice1: [{ type: core.Input }],
            choice2: [{ type: core.Input }],
            customStyleClass: [{ type: core.Input }],
            label: [{ type: core.Input }],
            change: [{ type: core.Output }]
        };
    ...
    var InputSwitchModule = /** @class */ (function () {
        ...
        InputSwitchModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.ReactiveFormsModule, inputswitch.InputSwitchModule],
    ...
    var InputSwitchTwoWayBindingModule = /** @class */ (function () {
        ...
        InputSwitchTwoWayBindingModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.ReactiveFormsModule, inputswitch.InputSwitchModule, forms.FormsModule],
    ...
    var InputSelectButtonTwoWayBindingModule = /** @class */ (function () {
        ...
        InputSelectButtonTwoWayBindingModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.ReactiveFormsModule, selectbutton.SelectButtonModule, forms.FormsModule],
    ...
    var InputMultiSelectComponent = /** @class */ (function () {
        ...
        InputMultiSelectComponent.propDecorators = {
            ...
            option: [{ type: core.Input }],
            filter: [{ type: core.Input }],
            maxSelectedItemsLabel: [{ type: core.Input }],
    ...
    var InputMultiSelectModule = /** @class */ (function () {
        ...
        InputMultiSelectModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.ReactiveFormsModule, checkbox.CheckboxModule, multiselect.MultiSelectModule],
    ...
    var RepeatFormComponent = /** @class */ (function () {
        function RepeatFormComponent(parentForm, formBuilder) {
            ...
            this.addedForm = new core.EventEmitter();
            this.addedFormZero = new core.EventEmitter();
         ...
         */
            function () {
                /** @type {?} */
                var validators = [forms.Validators.pattern(this.numberRegexPattern)];
                if (this.required) {
                    validators.push(forms.Validators.required);
                }
                if (this.minNumber) {
                    validators.push(forms.Validators.min(this.minNumber));
                }
                if (this.maxNumber && this.maxNumber > 0) {
                    validators.push(forms.Validators.max(this.maxNumber));
                }
                return validators;
            };
        /**
        ...
        /** @nocollapse */
        RepeatFormComponent.ctorParameters = function () {
            return [
        ...
        RepeatFormComponent.propDecorators = {
            ...
            inputNumberLabel: [{ type: core.Input }],
            removeLabel: [{ type: core.Input }],
            confirmLabel: [{ type: core.Input }],
            errorMessages: [{ type: core.Input }],
            controlName: [{ type: core.Input }],
            header: [{ type: core.Input }],
            isFormTouched: [{ type: core.Input }],
            entreprisesSizeVide: [{ type: core.Input }],
            addedForm: [{ type: core.Output }],
            addedFormZero: [{ type: core.Output }]
        };
    ...
    var FullCalendarComponent = /** @class */ (function () {
        function FullCalendarComponent() {
            ...
            this.dateRender = new core.EventEmitter();
        ...
        FullCalendarComponent.propDecorators = {
            ...
            dateRender: [{ type: core.Output }],
            dayCalander: [{ type: core.Input }],
            weekCalander: [{ type: core.Input }],
            slotDuration: [{ type: core.Input }],
            minTime: [{ type: core.Input }],
            maxTime: [{ type: core.Input }],
            scrollTime: [{ type: core.Input }],
            editable: [{ type: core.Input }],
            snapMinutes: [{ type: core.Input }],
            businessHours: [{ type: core.Input }],
            firstHour: [{ type: core.Input }],
    ...
    var FullAnfCalendarModule = /** @class */ (function () {
        ...
        FullAnfCalendarModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            common.CommonModule,
                            fullcalendar.FullCalendarModule,
    ...
    exports.ErrorModalModule = ErrorModalModule;
    exports.SuccessModalModule = SuccessModalModule;
    ...
    exports.InformationModalComponent = InformationModalComponent;
    exports.InformationModalModule = InformationModalModule;
    exports.GenericModalComponent = GenericModalComponent;
    exports.GenericModalModule = GenericModalModule;
    exports.ModalRadioModule = ModalRadioModule;
    exports.InputDateModule = InputDateModule;
    exports.InputDateComponent = InputDateComponent;
    exports.InputDateApproxModule = InputDateApproxModule;
    exports.InputDateApproxComponent = InputDateApproxComponent;
    exports.InputTextModule = InputTextModule;
    exports.InputTextComponent = InputTextComponent;
    exports.InputSelectModule = InputSelectModule;
    ...
    exports.InputCheckModule = InputCheckModule;
    exports.InputCheckComponent = InputCheckComponent;
    exports.InputTextareaModule = InputTextareaModule;
    exports.InputTextareaComponent = InputTextareaComponent;
    exports.InputDateTwoWayBindingModule = InputDateTwoWayBindingModule;
    exports.InputDateTwoWayBindingComponent = InputDateTwoWayBindingComponent;
    exports.InputTextTwoWayBindingModule = InputTextTwoWayBindingModule;
    exports.InputTextTwoWayBindingComponent = InputTextTwoWayBindingComponent;
    exports.InputMultiTextTwoWayBindingModule = InputMultiTextTwoWayBindingModule;
    exports.InputMultiTextTwoWayBindingComponent = InputMultiTextTwoWayBindingComponent;
    exports.InputSelectTwoWayBindingModule = InputSelectTwoWayBindingModule;
    exports.InputSelectTwoWayBindingComponent = InputSelectTwoWayBindingComponent;
    exports.InputMultiSelectTwoWayBindingModule = InputMultiSelectTwoWayBindingModule;
    exports.InputMultiSelectTwoWayBindingComponent = InputMultiSelectTwoWayBindingComponent;
    exports.InputRadioTwoWayBindingModule = InputRadioTwoWayBindingModule;
    exports.InputRadioTwoWayBindingComponent = InputRadioTwoWayBindingComponent;
    exports.InputCheckTwoWayBindingModule = InputCheckTwoWayBindingModule;
    exports.InputCheckTwoWayBindingComponent = InputCheckTwoWayBindingComponent;
    exports.InputTextareaTwoWayBindingModule = InputTextareaTwoWayBindingModule;
    exports.InputTextareaTwoWayBindingComponent = InputTextareaTwoWayBindingComponent;
    exports.VerticalMenuModule = VerticalMenuModule;
    ...
    exports.InputSwitchTwoWayBindingModule = InputSwitchTwoWayBindingModule;
    exports.InputSwitchTwoWayBindingComponent = InputSwitchTwoWayBindingComponent;
    exports.LoaderModule = LoaderModule;
    exports.InputSelectButtonTwoWayBindingModule = InputSelectButtonTwoWayBindingModule;
    exports.InputSelectButtonTwoWayBindingComponent = InputSelectButtonTwoWayBindingComponent;
    exports.InputMultiSelectModule = InputMultiSelectModule;
    exports.InputMultiSelectComponent = InputMultiSelectComponent;
    exports.RepeatFormModule = RepeatFormModule;
    exports.RepeatFormComponent = RepeatFormComponent;
    exports.FullAnfCalendarModule = FullAnfCalendarModule;
    exports.FullCalendarComponent = FullCalendarComponent;
    exports.EditTextByPencilModule = EditTextByPencilModule;
    exports.EditTextByPencilComponent = EditTextByPencilComponent;
    exports.ɵd = LoaderComponent;
    exports.ɵc = ModalRadioComponent;
    exports.ɵa = TrimPipe;
    exports.ɵb = Truncate;
...
//# sourceMappingURL=anef-ui.umd.js.map